...
<!-- Update the filenames below to match whatever is actually in the screenshots/ folder. -->

| Chat interface | Sidebar settings |
|---|---|
| ![Chat interface](screenshots/chat-interface.png) | ![Sidebar settings](screenshots/sidebar-settings.png) |
